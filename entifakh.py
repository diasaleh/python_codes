...
avgcat1=0
avgcat2=0
workbook = xlsxwriter.Workbook('/Users/diasaleh/Desktop/'+str(sys.argv[4])+'_shell_output/'+str(sys.argv[4])+'all_entifakh_details.xlsx')
worksheet = workbook.add_worksheet()
workbook2 = xlsxwriter.Workbook('/Users/diasaleh/Desktop/'+str(sys.argv[4])+'_shell_output/'+str(sys.argv[4])+'all_entifakh_details_2.xlsx')
