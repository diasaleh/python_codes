...
print(text)
wordsCC=0
for i in range(1,1822):
	wordsCA = 0
	out = open("/Users/diasaleh/Desktop/courpos/ForShell/midan/TN"+str(i%500)+".txt","a")
	print "========================================"
	print i
	f = open("/Users/diasaleh/Desktop/midan/midan ("+str(i)+").txt", 'r')
	text = f.read()
	...
	out.write(text)
	out.write("\n \n")
	print "/Users/diasaleh/Desktop/midan/tb ("+str(i)+").txt"
	f.close()
