...
workbook2 = xlsxwriter.Workbook('/Users/diasaleh/Desktop/'+(sys.argv[4])+'_shell_output/'+(sys.argv[4])+'avgWordL_2.xlsx')
...
avg=0
avgAvg=0
o = open('/Users/diasaleh/Desktop/'+(sys.argv[4])+'_shell_output/'+str(sys.argv[4])+'_averageWordLength.txt',"w")
